export const en = {
  ...
  bulk_import_hint: 'Required columns: Name, Sku, Price, MinimumStockQuantity, UnitOfMeasurement, CategoryName, SupplierName, SupplierCode, ContactName, ContactEmail (Description optional). Missing categories and suppliers will be created automatically.',
  ...
  supplier_contact_info: 'Contact info',
